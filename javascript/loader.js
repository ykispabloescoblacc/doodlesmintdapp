...
switch (collectionInfo.background.type) {
    ...
    case "image":
        ...
        const imageStyle = `<style> .body { background-image: url('images/genbox_header.png'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: center } </style>`
